...
class YoLov5TRT(object):
    ...
    def infer(self):
        ...
        global Frame,ret
        #cap=cv2.VideoCapture("rtsp://admin:hik12345@192.168.2.64:554//Streaming/Channels/101")
...
if __name__ == "__main__":
    camera_addr="rtsp://" + "admin" + ":" + "hik12345" + "@" + "192.168.2.64" + ":" + "554" + "//Streaming/Channels/101"
    ...
    categories = ['truck', 'bus', 'motorbike', 'person', 'tricycle', 'car']
    # a  YoLov5TRT instance
    yolov5_wrapper = YoLov5TRT(engine_file_path)

    # from https://github.com/ultralytics/yolov5/tree/master/inference/images
    #input_image_paths = ["hat.jpg"]
    #thread2 = read_frame(camera_addr)
    #thread2.start()
